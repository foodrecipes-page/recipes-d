...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'd'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-d@main/recipes/<cuisine>/<diet>/<slug>.json
```
